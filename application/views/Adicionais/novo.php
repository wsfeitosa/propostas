		...
		<td>                    
			...
			<table cellpadding="1" cellspacing="1" width="97%" border="0" align="center" class="tabela_padrao">
				...
				<div id="dialog-confirm" title="Influenciar Retroativos?">
					<p style="font-size: 12px; color: black;"><span class="ui-icon ui-icon-alert" style="float:left; margin:0 7px 50px 0;"></span>Deseja validar esse acordo para todas as propostas (Cotação e Tarifário) existentes ou apenas para as novas ?</p>
				</div>                     
				<tr>
					<td colspan="2" >
						Número:
				...
				<tr>					
					<td class="texto_pb">							
						<input type="text" title1="Data em que o acordo começará a valer efetivamente" name="inicio" id="inicio" readonly="readonly" value="<?php echo date('d-m-Y');?>" />											
					</td>					
					<td class="texto_pb">							
						<input type="text" title1="Data limite em que o acordo será válido" name="validade" id="validade" readonly="readonly" value="<?php echo date("t-m-Y");?>" />
					</td>																					      
				</tr>
				<tr>										
					<td colspan="4">
				...
				<tr>
					...
					<td class="texto_pb" colspan="2">
						<?php echo form_textarea(Array('name' => 'observacao_interna', 'id' => 'observacao_interna', 'value' => "", 'rows' => 8, 'title' => "Permite escrever uma observação interna, não será visualizada pelo cliente.")); ?>						
					</td>										
				</tr>									                                                                                     
			</table>                        
		</td>
