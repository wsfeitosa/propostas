...
foreach ($proposta->obterEmails() as $email) 
{
    if( $email->getTipo() == "P" )
    {   
        $emails_para[$email->getEmail()] = $email->getEmail();
    }
    else 
    {
        $emails_cc[$email->getEmail()] = $email->getEmail();
    }    
}
?>
<table border="0" cellpadding="0" cellspacing="0" width="100%" align="center" class="tabela_azul">
    <tr>
        <td>                    
            ...
            <input type="hidden" name="tipo_proposta" id="tipo_proposta" value="proposta_nac" />
            <table cellpadding="1" cellspacing="1" width="97%" border="0" align="center" class="tabela_padrao">
                ...
                <tr>
                    ...
                    <td class="texto_pb" colspan="2">							
                        <?php echo form_dropdown("contatos_cc_selecionados[]", $emails_cc, "", "id='contatos_cc_selecionados' multiple='multiple' size='5'"); ?>	
                ...
                <tr>
                    <td colspan="2" class="texto_pb">
                        <?php echo form_dropdown("contatos_para_selecionados[]", $emails_para, "", "id='contatos_para_selecionados' multiple='multiple' size='5'"); ?>	
                    ...
                    <td colspan="2" class="texto_pb">
                    	<input type="text" name="nome_nac" id="nome_nac" size="45" value="<?php echo $proposta->getNomeNac(); ?>" />
                    </td>
                </tr>	
                <tr>
                ...
                <tr>
					...
					<td class="texto_pb">	
                        <input type="button" name="buscar_tarifarios" id="buscar_tarifarios" value="Buscar" />
