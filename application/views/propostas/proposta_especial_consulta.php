                ...
                <div id="accordion" style="padding:10px; width:99%;">
                    ...
                    <div>
                        ...
                        <table cellpadding="1" cellspacing="1" width="97%" border="0" align="center" class="tabela_padrao">
                        	...
                        	<tr>                               
                                <td colspan="2" class="texto_pb"><?php echo $item->getInicio()->format("d/m/Y"); ?></td>
                                <td colspan="2" class="texto_pb" <?php echo $style_validade;?>><?php echo $item->getValidade()->format("d/m/Y"); ?></td>                                
                            </tr>
                            <tr>
