        ...
        <td>                    
            ...
            <table cellpadding="1" cellspacing="1" width="97%" border="0" align="center" class="tabela_padrao">
                ...
                <tr>
	                ...
	                <td colspan="2" class="texto_pb">
	                	<?php if(isset($proposta->usuario_alteracao)){ echo $proposta->usuario_alteracao->getNome() . " em: " . $proposta->data_alteracao->format('d/m/Y H:i:s');}?>
	                </td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="1" class="texto_pb" align='right' width="46%">
                        <div id="ver_mais_carregando_esquerda"></div>
                    </td>    
                    <td colspan="2" class="texto_pb" width='8%' align='center'>
                        <input type="button" name="ver_mais" id="ver_mais" value="Ver Mais Itens" />&nbsp;                        
                    </td>
                    <td colspan="1" class="texto_pb" align='left' width="46%">
                        <div id="ver_mais_carregando_direita"></div>
                    </td>
                </tr>
                </table>
