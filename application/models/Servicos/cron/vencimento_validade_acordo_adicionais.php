...
{
	echo "FIM -> Nenhum acordo de incentivos à vencer!";exit;
}	
...
{    
    ...
    {                  
        ...
        if( $contRowsPan === 1  )
        {
            ...
            $coluna = '<td class="texto_pb1" align="center" '.$rowspan.'>
                            ...
                            <a href="http://'.$_SERVER['SERVER_ADDR'].'/Clientes/propostas/index.php/adicionais/adicionais/revalidar/'.$acordo['acordo']['id'].'/1">1 MÊS</a> | 
	...
	$mensagem .='
                    ...
                    <tr>
                        <td class="texto_pb1" colspan="7" align="center">Cubagem dos últimos 06 meses (M³)</td>
                    </tr>
                    <tr>
                        <td class="texto_pb1" colspan="7">&nbsp;</td>
                    </tr>
