...
/** Calandários JQuery **/
    ...
    $("#taxas_selecionadas").dblclick(function() {
        ...
        if( $("#id_acordo").val() != undefined  )
        {         
        	document.getElementById("frame").src = "/Clientes/propostas/index.php/desbloqueios/desbloqueios/taxa/" + $("#sentido").val() + "/" + id + "/Taxa_Local/" + $("#id_acordo").val() + "/" + index + "/taxa_local";
    ...
    $("#salvar").click(function(){
        ...
        portos_selecionados +="NULL";
    	
    	 $.ajax({
             type: "POST",
             url: "/Clientes/propostas/index.php/taxas_locais/taxas_locais/check_before_save/" + clientes_selecionados + "/" + portos_selecionados + "/" + $("#sentido").val() + "/" + $("#inicio").val() + "/" + $("#validade").val() + "/" + $("#id_acordo").val(),
             beforeSend: function() {
                 $("#msg").html("Aguarde Processando...");
             },
             dataType: "xml",
