$(document).ready(function() {
    ...
    $("#destino").blur(function() {
        ...
        if ($("#sentido").val() == "IMP")
        {
            document.getElementById("frame").src = "/Clientes/propostas/index.php/portos/portos/find_destination/" + $("#destino").val() + "/Importacao/proposta_tarifario";

            $("#pop").show("slow");
        }
        else
        {
        	document.getElementById("frame").src = "/Clientes/propostas/index.php/portos/portos/find_destination/" + $("#destino").val() + "/Exportacao/proposta_tarifario";
    ...
    /** Faz a busca pelos tarifários encontrados **/
    $("#buscar_tarifarios").click(function(){
    	...
    	{
    		erro = true;
    		msg += "Selecione pelo menos um cliente antes de consultar!\n";
    	}	
    	...
    	/** verifica se os portos foram preenchidos **/
    	var receipt = "NULL";
    	var loading = "NULL";
    	var discharge = "NULL";
    	var destination = "NULL";
    	
    	if( $("#un_origem").val() != "" && $("#un_origem").val() != undefined )
    	{
    		receipt = $("#un_origem").val();
    	}	
    	
    	if( $("#un_embarque").val() != "" && $("#un_embarque").val() != undefined )
    	{
    		loading = $("#un_embarque").val();
    	}	
    	
    	if( $("#un_desembarque").val() != "" && $("#un_desembarque").val() != undefined )
    	{
    		discharge = $("#un_desembarque").val();
    	}
    	
    	if( $("#un_destino").val() != "" && $("#un_destino").val() != undefined )
    	{
    		destination = $("#un_destino").val();    		
    	}
    	...
    	{    		
    		...
    		document.getElementById("frame").src = "/Clientes/propostas/index.php/tarifarios/tarifarios/listFound/" + clientes + "/" + receipt + "/" + loading + "/" + discharge + "/" + destination + "/" + 
    		$("#sentido").val() + "/" + ppcc + "/" + $("#inicio").val() + "/" + $("#validade").val() + "/" + imo + "/proposta_tarifario";
